...
import { CompositeOrderProps } from "../types/account.types";
import { ASSETS, INFURA_GATEWAY } from "@/app/lib/constants";
import { convertDate } from "@/app/lib/helpers/convertDate";
import { useModal } from "connectkit";

const CompositeOrder: FunctionComponent<CompositeOrderProps> = ({
  order,
  orderOpen,
  setOrderOpen,
  index,
                  ...
                  <div className="relative w-10 h-10 rounded-md">
                    <Image
                      src={`${INFURA_GATEWAY}/ipfs/${
                        order?.compositeMetadata?.image?.split("ipfs://")[1]
                      }`}
