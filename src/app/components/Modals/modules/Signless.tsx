...
const Signless: FunctionComponent<{ dict: any }> = ({ dict }): JSX.Element => {
  ...
  return (
    ...
    >
      <div
        className="w-96 h-fit text-sm text-white bg-black border border-brillo rounded-md font-mana flex items-center justify-start p-3 cursor-default flex-col gap-10"
